import 'package:tutor6/main.dart';
                                          ...
                                          child: Container(
                                            child: ListView(
                                              ...
                                              children: <Widget>[
                                                Center(child: Text(
                                                  'Judul : ' + _namaLengkap +
                                                  '\nJenjang : ' + (jenjangSarjana ? 'Sarjana' : jenjangDiploma ? 'Diploma' : jenjangMagister ? 'Magister' : jenjangDoktor ? 'Doktor' : 'Silahkan Memilih Jenjang') + 
                                                  '\nUmur : ' + umur.toString() + 
                                                  '\nKelas : ' + kelasPBP +
                                                  '\nStatus : ' + (_nilaiSwitch ? 'On Practice Mode' : 'Not On Practice Mode'))),
                                                SizedBox(height: 20),
